...
export default function Profile() {
  ...
  useEffect(() => {
    ...
    // Fetch all orders, then filter by this user's email
    // (In a real app, the backend would only return this user's orders based on token)
    ...
    <div style={{ padding: 20, maxWidth: 800, margin: "0 auto" }}>
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 24 }}>
        ...
        <button 
          ...
          style={{ padding: "8px 16px", borderRadius: 8, border: "1px solid #c00", background: "#fff", color: "#c00", cursor: "pointer", fontWeight: "bold" }}
        >
          Logout
        </button>
      </div>

      <div style={{ background: "#f9f9f9", padding: 20, borderRadius: 12, marginBottom: 32 }}>
